= Spring Boot - Sample Applications with Google Cloud Spanner

== Description
This fork of Spring Boot contains a number of sample applications that have been modified to work with Google Cloud Spanner instead of the standard in-memory test databases (H2), to show how Cloud Spanner could easily and with little modifications could be (retro-)fitted under Spring Boot applications.
